...
export const BAND_WEBSITE_CONFIG: BandWebsiteConfig = {
    ...
    genres: ['pop','funk'],
    logo: {
        src: 'https://media.bandpractice.app/bands/9b1deb4d-3b7d-4bad-9bdd-2b0d7b3dcb6d/bandFiles/images/the-sips-can-logo-no-bg-2.png',
    ...
    socialMedia: [
        ...
        {platform: 'spotify', pageSrc: 'https://open.spotify.com/artist/4QMmBetHc1LFnQGeH7Dzr3'},
